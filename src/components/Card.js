...
const Card = () => {
    ...
    const handleSubmit=()=>{
      setClicked(true)
      if(rating>0) setFlip(true)
    }
  return (
    <div className={`card ${flip===true? "rotate":""} `}>
      {rating===0 &&
      <div className="alert" style={{visibility:`${clicked===true?"visible":"hidden"}`, transform:"1sec"}}>
      ...
      <div className="card__front">
        <div className="card__items">
          ...
          <div className="rating__btn">
                <button className="rating-1 rating" onClick={()=>setRating(1)} style={{backgroundColor:`${rating===1?"hsl(25, 97%, 53%)":""}`, opacity:`${rating===1?"100%":""}`}} >1</button>
                <button className="rating-2 rating" onClick={()=>setRating(2)} style={{backgroundColor:`${rating===2?"hsl(25, 97%, 53%)":""}` , opacity:`${rating===2?"100%":""}`}}>2</button>
                <button className="rating-3 rating" onClick={()=>setRating(3)} style={{backgroundColor:`${rating===3?"hsl(25, 97%, 53%)":""}` , opacity:`${rating===3?"100%":""}`}}>3</button>
                <button className="rating-4 rating" onClick={()=>setRating(4)} style={{backgroundColor:`${rating===4?"hsl(25, 97%, 53%)":""}` , opacity:`${rating===4?"100%":""}`}}>4</button>
                <button className="rating-5 rating" onClick={()=>setRating(5)} style={{backgroundColor:`${rating===5?"hsl(25, 97%, 53%)":""}` , opacity:`${rating===5?"100%":""}`}}>5</button>
          </div>
          <button className="btn" type="submit" onClick={handleSubmit} ><p>SUBMIT</p></button>
        </div>
      </div>
